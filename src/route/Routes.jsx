...
const Routes = createBrowserRouter([
  {
    ...
    children: [
      {
        path: "/",
        loader:()=>axios.get('https://car-com-backend-hlo2j6lud-jhriyazs-projects.vercel.app/cars'),
        element:<Home></Home>
      },
      {
        path:"/login",
      ...
      },
      {
       ...
       element:<PrivateRoute><Cart/></PrivateRoute>
        ...
        path:"/cars/:id",
        loader:({params})=>axios.get(`https://car-com-backend-hlo2j6lud-jhriyazs-projects.vercel.app/cars/${params.id}`),
      ...
      {
        path:"/brand/:brand",
        loader:({params})=>axios.get(`https://car-com-backend-hlo2j6lud-jhriyazs-projects.vercel.app/brand/${params.brand}`),
